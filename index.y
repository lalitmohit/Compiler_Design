...
%token EQUALEQUAL NOEQUAL GREATEREQUAL LESSEQUAL GREATER LESSER MODULOEQUAL MINUSEQUAL
%token PLUSEQUAL MULTIEQUAL DIVEQUAL DIVISION MODULO PLUS MINUS MULTIPLY NOT_OPERATOR AND_OPERATOR OR_OPERATOR 
%token XOR_OPERATOR LEFT_SHIFT_EQUAL RIGHT_SHIFT_EQUAL SWITCH DEFAULT
